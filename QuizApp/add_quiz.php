    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="www.technopoints.com">Online Quiz</a>
        </div>
        <div class="navbar-collapse collapse" class="toactive">
          <ul class="nav navbar-nav" class="list-inline">
            ...
            <li class="cli"><a href="result.php">Result</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
<div class="col-sm-3">
			...
			<button type="submit" class="btn btn-primary btn-large" value="submit" name="timesubmit">+Set Time</button>
<form>
</div></div>
<?php

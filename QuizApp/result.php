    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="result.php">Online Quiz</a>
        </div>
        <div class="navbar-collapse collapse" class="toactive">
          <ul class="nav navbar-nav" class="list-inline">
            ...
            <li class="cli active"><a href="result.php">Result</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
<h2>Result:</h2><br><br>
 <span style="font-size: 30px;"><b>No. of Correct Answer:</b>&nbsp;<?php  echo $no = @$_SESSION['score']; 
											//var_dump($_SESSION['ids']);
 //session_unset(); ?></span><br><br>
 <span style="font-size: 30px;"><b>Your Score:</b>&nbsp<?php if(isset($no)) echo $no*2; ?></span>
</div>